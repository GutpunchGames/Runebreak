...
#define UE_PROJECT_NAME RunebreakGame
#define UE_TARGET_NAME RunebreakGameEditor
#define UE_MODULE_NAME "RunebreakGame"
...
#define RUNEBREAKGAME_API DLLEXPORT
