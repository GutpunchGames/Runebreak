...
void GameSimulationSerializer::WriteClass(UClass* Value) {
    memcpy(Buffer + Size, &Value, sizeof(Value));
    Size += sizeof(Value);
}
...
void GameSimulationDeserializer::ReadClass(UClass** Destination) {
